...
+(void)cancelAllRequest{
    ...
    [[AFNetManager shareManager].operationQueue cancelAllOperations];
...
+(void)cancelHttpRequestWithRequestType:(NSString *)requestType requestUrlString:(NSString *)string{
    ...
    NSString * urlToPeCanced = [[[[AFNetManager shareManager].requestSerializer requestWithMethod:requestType URLString:string parameters:nil error:&error] URL] path];
    
    
    for (NSOperation * operation in [AFNetManager shareManager].operationQueue.operations) {
